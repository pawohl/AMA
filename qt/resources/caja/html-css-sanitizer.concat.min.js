...
schema;elide||(schema=cssSchema[property],schema&&(sanitizeCssProperty(property,schema,valueArray,opt_naiveUriRewriter,baseUri),valueArray.length&&safeCss.push(property,':',valueArray.join(' '),';')))}});function
...
ALLOWED_URI_SCHEMES,ATTR_RE,EFLAGS_TEXT,ENTITIES,ENTITY_RE_1,ENTITY_RE_2,URI_SCHEME_RE,ampRe,continuationMarker,cssSchema,decimalEscapeRe,endTagRe,gtRe,hexEscapeRe,html,looseAmpRe,ltRe,nulRe,parseCssDeclarations,quotRe,sanitizeCssProperty,splitWillCapture;'undefined'!==typeof
...
safeUri(uri,effect,ltype,hints,naiveUriRewriter){var parsed;return naiveUriRewriter?(parsed=(''+uri).match(URI_SCHEME_RE),parsed&&(!parsed[1]||ALLOWED_URI_SCHEMES.test(parsed[1]))?naiveUriRewriter(uri,effect,ltype,hints):null):null}function
