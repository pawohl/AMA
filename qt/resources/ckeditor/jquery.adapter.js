...
// The following code was migrated to util.js because it must be present before ....
$.widget("ui.dialog", $.ui.dialog, {
	_allowInteraction: function( event ) {
		$et = $( event.target );
		if ( $et.closest(".ui-dialog").length || $et.closest(".cke_dialog_ui_input_text").length ) {
			return true;
		}

		// TODO: Remove hack when datepicker implements
		// the .ui-front logic (#8989)
		return !!$et.closest(".ui-datepicker").length;
	}
});
